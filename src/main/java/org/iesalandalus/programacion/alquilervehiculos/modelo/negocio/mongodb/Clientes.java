...
public class Clientes implements IClientes {
	...
	public void insertar(Cliente cliente) throws OperationNotSupportedException {
		...
		Document resultado = coleccionClientes.findOneAndReplace(getCriterioBusqueda(cliente), getDocumento(cliente),
				opciones);
		if (resultado != null) {
	...
	public void modificar(Cliente cliente, String nombre, String telefono) throws OperationNotSupportedException {
		...
		if (telefono != null && !telefono.isBlank()) {
			modificacion = (modificacion == null) ? set(TELEFONO, telefono)
					: combine(modificacion, set(TELEFONO, telefono));
		}
		if (modificacion != null) {
			Document clienteModificado = coleccionClientes.findOneAndUpdate(getCriterioBusqueda(cliente), modificacion,
